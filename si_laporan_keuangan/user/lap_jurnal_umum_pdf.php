...
$header = '<h1 align="center" style="margin:0px; margin-bottom:10px">' . $judul . '</h1>';
$header .= '<h4 align="center" style="margin:0px; margin-bottom:10px"> Unit : ' . $unit . ' </h4>';
$header .= '<h4 align="center" style="margin:0px; margin-bottom:10px"> Jenis Usaha : ' . $usaha . ' </h4>';
$periode = '<p align="center" style="margin:0px; margin-bottom:10px"> Periode : ' . $periode . '</p>';
