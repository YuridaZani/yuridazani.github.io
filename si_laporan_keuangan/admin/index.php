...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="#" class="brand-link">
        <span class="brand-text font-weight-light">Keuangan Kita</span>
      </a>
  ...
  <footer class="main-footer">
    ...
    <div class="float-right d-none d-sm-inline">
      Mengelola Keuangan UMKM dengan Mudah
    </div>
    <!-- Default to the left -->
    <strong>Copyright &copy; 2024 KeuanganKita</a>.</strong> All rights reserved.
